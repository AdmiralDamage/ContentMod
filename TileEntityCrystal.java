package eu.tetrabyte.contentmod.tileentity;
...
public class TileEntityCrystal extends TileEntityLockable implements ITickable, IInventory
{
    /** List of effects that Beacon can apply */
    public static final Potion[][] effectsList = new Potion[][] {{Potion.moveSpeed, Potion.digSpeed}, {Potion.resistance, Potion.jump}, {Potion.damageBoost}, {Potion.regeneration}};
    private final List<TileEntityCrystal.BeamSegment> beamSegments = Lists.<TileEntityCrystal.BeamSegment>newArrayList();
    ...
    private void updateSegmentColors()
    {
        ...
        TileEntityCrystal.BeamSegment tileentitybeacon$beamsegment = new TileEntityCrystal.BeamSegment(EntitySheep.func_175513_a(EnumDyeColor.PURPLE));
        ...
        for (int i1 = k + 1; i1 < 256; ++i1)
        {
            ...
            {
                tileentitybeacon$beamsegment = new TileEntityCrystal.BeamSegment(afloat);
                this.beamSegments.add(tileentitybeacon$beamsegment);
            }
    ...
    @SideOnly(Side.CLIENT)
    public List<TileEntityCrystal.BeamSegment> getBeamSegments()
    {
